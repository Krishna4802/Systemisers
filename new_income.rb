...
wait_for_duration(2)
wait.until{driver.find_element(xpath: "//button[text()='  No  ']")}.click
...
wait.until{driver.find_element(xpath: "//button[text()=' Download Form ']")}.click
wait_for_duration(20)
wait.until{driver.find_element(xpath: "//button[text()=' Download JSON ']")}.click
wait_for_duration(5)
