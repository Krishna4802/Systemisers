module ProjectReport
  class DepreciationSchedule
    ...
    def generate_depreciation_schedule(_opening_balance, addition, depreciation_percent, is_less_than_6_months)
      ...
      @projection_years.times do |year|
        current_opening_balance = (year == 0 ? 0 : balance).round(2)
        ...
        schedule << {
          ...
          addition: (year == 0 ? addition.round(2) : 0.0),
    ...
    def generate_totals
      ...
      totals.each { |key, values| totals[key] = values.map { |v| v.round(2) } }
      totals
    end
